...
public class EmployeeHomeSceneController implements Initializable {
    ...
    @FXML
    private void requestLeaveButtonOnAction(ActionEvent event) throws IOException {
    ...
    @FXML
    private void viewCommitteeInfoButtonOnAction(ActionEvent event) throws IOException 
    {
         Parent scene2Parent = FXMLLoader.load(getClass().getResource("employeeViewCommitteeInfoScene_g1.fxml"));
         Scene scene2 = new Scene(scene2Parent);
         Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
