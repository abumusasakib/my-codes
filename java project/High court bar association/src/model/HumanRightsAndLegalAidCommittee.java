 ...
 * @author sakib
 */
public class HumanRightsAndLegalAidCommittee extends User{

    private String complaintID,meetingDate, meetingType, meetingTime, meetingLocation, meetingLink, meetingSetBy;
    public void seeProgress(String id) {
        this.complaintID = id;
        Alert a = new Alert(Alert.AlertType.INFORMATION);
         a.setTitle("Complaint");
         a.setHeaderText("Progress");
         a.setContentText("Complaint "+ complaintID+ " is going good");
         a.showAndWait();
    }
