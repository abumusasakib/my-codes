 ...
 * @author sakib
 */
public class ExecutiveCommitteeValidateLeaveRequestScene1_g3Controller implements Initializable {
    ...
    private void viewLeaveRequestButtonOnAction(ActionEvent event) throws IOException 
    {
       ...
       String body = lr.getBody();
        ...
        loader.setLocation(getClass().getResource("executiveCommitteeViewLeaveRequestScene2_g3.fxml"));
        ...
        ExecutiveCommitteeViewLeaveRequestScene2_g3Controller controller = loader.getController();
